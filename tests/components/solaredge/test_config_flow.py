...
async def test_user(hass: HomeAssistant, test_api: Mock, test_ha_api: Mock) -> None:
    """Test user config."""
...
async def test_import(hass: HomeAssistant, test_api: Mock, test_ha_api: Mock) -> None:
    """Test import step."""
    flow = init_config_flow(hass)
...
async def test_abort_if_already_setup(hass: HomeAssistant, test_api: str, test_ha_api: str) -> None:
...
async def test_asserts(hass: HomeAssistant, test_api: Mock, test_ha_api: Mock) -> None:
...
async def test_ha_asserts(hass: HomeAssistant, test_api: Mock, test_ha_api: Mock) -> None:
    """Test the _site_in_configuration_exists method."""
    flow = init_config_flow(hass)
